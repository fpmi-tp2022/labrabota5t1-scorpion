...
{
    cout << "Меню:\n";
    cout << "1. Просмотреть заказы за период\n";
    cout << "2. Просмотреть количество поездок\n";
    cout << "3. Просмотреть общую массу перевезенных грузов\n";
    cout << "4. Просмотреть заработанную сумму за все время\n";
    cout << "5. Просмотреть заработанную сумму за период\n";
    cout << "6. Просмотреть сведения о машине с наибольшим пробегом\n";
    cout << "7. Выйти\n";
}
